...
namespace Power_Station_System.DataBase
{
    class fines
    {
        ...
        public void Add_fines_reales(int fines_type_ID, int ID_Subscriber,string fine_data)
        {
            access = new DataBase.Access_layer();
            SqlParameter[] prarm = new SqlParameter[3];
            access.open();
            prarm[2] = new SqlParameter("@fine_type", SqlDbType.Int);
            prarm[2].Value = fines_type_ID;
            prarm[1] = new SqlParameter("@iD_Subscriber", SqlDbType.Int);
            prarm[1].Value = ID_Subscriber;
        ...
        public void ubdate_fines_reales(int fines_type_ID, int ID_Subscriber, string fine_data,int ID)
        {
            DataBase.Access_layer access = new DataBase.Access_layer();
            SqlParameter[] para = new SqlParameter[4];
            access.open();
            para[0] = new SqlParameter("@fine_type", SqlDbType.Int);
            para[0].Value = fines_type_ID;
            para[1] = new SqlParameter("@subscriper_id", SqlDbType.Int);
            para[1].Value = ID_Subscriber;
