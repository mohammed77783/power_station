...
namespace RJCodeAdvance.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Power_Station_System.Properties.Resources.CalendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Power_Station_System.Properties.Resources.CalendarWhite;
                else calendarIcon = Power_Station_System.Properties.Resources.CalendarWhite;
                this.Invalidate();
            }
        }
        ...
        {
            return obj is RJDatePicker picker &&
                   EqualityComparer<Image>.Default.Equals(calendarIcon, picker.calendarIcon);
        }
    }
}
